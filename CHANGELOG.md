...
### Added
- Added FITS input/output support for `IndependentStatistic` through the `AstroFITS` extension.

### Changed
- Switched package test setup to workspace-based layout (`[workspace]` + `test/Project.toml`) replacing legacy `[targets]` usage.
